...
public class ApptRandomTest {
   ...
   /**
	...
	//			System.out.println(" Seed:"+randomseed );
	 ...
	 @Test
		public void isValidRadnomTest()  throws Throwable  {
	...
	//			System.out.println(" Seed:"+randomseed );
				...
				int startYear;
				 ...
				 int rh = ValuesGenerator.RandInt(random);
				 if (rh%2 == 0){
				 		startHour=ValuesGenerator.getRandomIntBetween(random, -100, -1);
					}
					else if(rh%3 == 0){
					...
					rh = ValuesGenerator.RandInt(random);
					if (rh%3 == 0){
				 		startMinute=ValuesGenerator.getRandomIntBetween(random, -100, -1);
					}
					else if( rh%5 == 0){
					...
					rh = ValuesGenerator.RandInt(random);
					if (rh%5 == 0){
				 		startDay=ValuesGenerator.getRandomIntBetween(random, -100, 0);
			 			}
					else{
					...
					rh = ValuesGenerator.RandInt(random);
					if (rh%7 == 0){
				 		startMonth=ValuesGenerator.getRandomIntBetween(random, -100, 0);
					}
					else if (rh%2 == 0){
					...
					rh = ValuesGenerator.RandInt(random);
					if (rh%2 == 0){
				 		startYear=ValuesGenerator.getRandomIntBetween(random, -100, 0);
					}
					else{
